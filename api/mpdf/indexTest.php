...
';
        ...
        <div class="body">
            ...
            <div class="customer-details margin-top">
                <table style="width:100%">
                    ...
                    <tr>
                        ...
                        <td width="70%" >VALUEVALUEVALUEVALUE</td> 
                    </tr>
                    <tr>
            ...
            <div class="mailer-details margin-top">
                ...
                <p class="bold-text">SHARED MAILINGS TARGETS AND DATES</p>

                <table style="width:100%">
                    <tr>
                        <th width="50%" class="bold-text text-left">Name	</th> 
                        <th width="25%" class="bold-text text-left">Copy Date	</th>
                        <th width="25%" class="bold-text text-left">Package</th>
                    </tr>
                    <tr>
                        <td width="50%" >5000 Academies (79) - 1st June 15</td>
                        <td width="25%" >26th May</td> 
                        <td width="25%" >Design, Print, Pack, Post</td>
                    </tr>
                </table>
            ...
            <div class="disclaimer">
                <h3 class="tick-box-text">Please click the box &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; to join the service and its terms & con-ditions. Please ensure that you have the relevant authority within your organisation to commit your company to this service. <br>Thanks for your business.</h3>
            </div>
